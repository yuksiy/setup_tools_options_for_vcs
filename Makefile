...
# Macro Defines
PROJ = setup_tools_options_for_vcs
VER = 1.0.0
TAG = v$(VER)
...
DOC = \
				...
				TODO \
				examples/README.md \
				examples/dot.setup_fil_vcs.DebianX.X.conf \
				examples/dot.setup_fil_vcs.FedoraXX.conf \
				examples/dot.setup_fil_vcs_list.DebianX.X.conf \
				examples/dot.setup_fil_vcs_list.FedoraXX.conf \
